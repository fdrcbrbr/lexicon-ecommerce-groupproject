...
export default async function ProductsPage({
  ...
  let result: ProductsRes;
  let products: Products[] = [];

  try {
    result = query
      ? await searchProducts(query, category)
      : await getProductsForSection(category);
    ...
    return (
      <div className="w-[90vw] mx-auto border-t-2 border-gray-100">
        <SearchBar />
                  ...
                  <div className="text-gray-400 mb-4">
                    ...
                    >
                      <path
                        ...
                        strokeWidth={2}
                        d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2 2v-5m16 0h-2M4 13h2m7-6v2m0 4v2"
                      />
                    </svg>
                  </div>
